...
description: Save durable decisions, findings, plans, and implementation knowledge from the visible Kimi Code conversation into a new or existing NeatContext lite context. Use only when the user explicitly invokes this skill or asks to preserve the current conversation as reusable context.
---
